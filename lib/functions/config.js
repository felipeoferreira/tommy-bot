...
exports.kconfig = async (fun, mesg) => {
	...
	try {
		...
		const quoMens =
      (message.quotedMsg !== null && message.quotedMsg !== undefined)
        ? message.quotedMsg
        : (message.quotedMsgObj !== null && message.quotedMsgObj !== undefined)
          ? message.quotedMsgObj
          : {};
    const quotObjmes =
    (message.quotedMsgObj !== null && message.quotedMsgObj !== undefined) ? message.quotedMsgObj : quoMens;
